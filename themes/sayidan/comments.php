...
<div class="comments-area write-comments">
    <div class="box-comments">
        ...
        $fields =  array(
             ...
             '<input id="author" name="author" type="text" placeholder="' . esc_html__( 'Name', 'sayidan' ) . '" value="' . esc_attr( $commenter['comment_author'] ) .
             '" size="30"' . $aria_req . ' /></p>',
             
             'email' =>
             '<p class="comment-form-email">' .
             ( $req ? '<span class="required"></span>' : '' ) .
             '<input id="email" name="email" type="text" placeholder="' . esc_html__( 'Email', 'sayidan' ) . '" value="' . esc_attr(  $commenter['comment_author_email'] ) .
             '" size="30"' . $aria_req . ' /></p>',
             
             'url' =>
             '<p class="comment-form-url">' .
             '<input id="url" name="url" type="text" placeholder="' . esc_html__( 'Website', 'sayidan' ) . '" value="' . esc_attr( $commenter['comment_author_url'] ) .
             '" size="30" /></p>',
             );
